...
var require_src = __commonJS({
  "node_modules/mdast-builder/lib/src/index.js"(exports2) {
    "use strict";
    ...
    exports2.text = (value) => valueNode("text", value);
    exports2.inlineCode = (value) => valueNode("inlineCode", value);
    exports2.html = (value) => valueNode("html", value);
    exports2.strong = (kids) => nodeWithChildren("strong", kids);
    exports2.emphasis = (kids) => nodeWithChildren("emphasis", kids);
    exports2.strike = (kids) => nodeWithChildren("delete", kids);
    exports2.tableCell = (kids) => nodeWithChildren("tableCell", kids);
    exports2.tableRow = (kids) => nodeWithChildren("tableRow", kids);
    exports2.table = (align, kids) => Object.assign({}, nodeWithChildren("table", kids), { align });
    exports2.brk = Object.freeze({ type: "break" });
    exports2.separator = exports2.text("---");
    exports2.link = (url, title = "", kids) => Object.assign({}, nodeWithChildren("link", kids), {
      url,
      title
    });
    exports2.root = (kids) => nodeWithChildren("root", kids);
    exports2.rootWithTitle = (depth, title, kids) => {
      return exports2.root([exports2.heading(depth, title), ...normalizeChildren(kids)]);
    };
    exports2.paragraph = (kids) => nodeWithChildren("paragraph", kids);
    exports2.image = (url, title, alt, kids) => Object.assign({}, nodeWithChildren("image", kids), { url, title, alt });
    exports2.blockquote = (kids) => nodeWithChildren("blockquote", kids);
    exports2.code = (lang, value) => Object.assign({}, valueNode("code", value), { lang });
    exports2.heading = (depth, kids) => {
      if (depth < 1)
        throw new Error(`Invalid depth: ${depth}`);
      return Object.assign({}, nodeWithChildren("heading", kids), { depth });
    };
    exports2.list = (ordered, kids) => Object.assign({}, nodeWithChildren("list", kids), { ordered: ordered === "ordered" });
    exports2.listItem = (kids) => nodeWithChildren("listItem", kids);
  }
});
...
function toSlug(s2) {
  return (0, import_slugify.default)(s2, { decamelize: false });
}
...
var myWikiParser = function(opts = {}) {
  ...
  return (tree) => {
    ...
    (0, import_unist_util_visit2.visit)(tree, "wikiLink", (node, index, parent) => {
      ...
      return [import_unist_util_visit2.SKIP, index];
    });
    if (debug) {
...
var unifiedProcessorBuilder = ({ toLink }) => {
  return (0, import_unified.unified)().use(import_remark_parse.default).use(import_remark_gfm.default).use(myWikiParser, {
    debug: true,
    toLink,
    toImage: ({ value, alias }) => ({
      uri: `/assets/${value}`,
